...
from SMGAN.imresize import imresize
import SMGAN.functions as functions


if __name__ == '__main__':
    parser = get_arguments()
    parser.add_argument('--input_dir', help='input phrase dir', default='npy')
    parser.add_argument('--input_phrase', help='input phrase name', default='1.npy', required=True)
