...
from SMGAN.xl_utils.proj_adaptive_softmax import ProjectedAdaptiveLogSoftmax
from SMGAN.xl_utils.log_uniform_sampler import LogUniformSampler, sample_logits
